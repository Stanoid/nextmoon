...
const translations = {
  ar: {
    ...
    login: "تسجيل دخول",
    products: "منتجات",
    ourWonderfulProducts: "من منتجاتنا الرائعة",
    cart: "السلة",
    home: "الرئيسية",
    ...
    jobsComingSoon: "الوظائف قريباً",
    jobsComingSoonDescription: "نحن نعمل على إضافة فرص عمل جديدة. تابعنا للحصول على التحديثات حول الوظائف المتاحة قريباً.",
    growthOpportunities: "فرص النمو",
    growthOpportunitiesDesc: "نوفر فرصاً للتطور المهني والنمو الوظيفي",
    globalTeam: "فريق عالمي",
    globalTeamDesc: "اعمل مع فريق متنوع من أكثر من 10 دول",
    benefits: "المزايا",
    benefitsDesc: "نقدم حزمة مزايا تنافسية لموظفينا",
    ourStores: "متاجرنا",
    ...
    itemOutOfStock: "المنتج غير متوفر",
  ...
  fr: {
    ...
    login: "Se connecter",
    products: "produits",
    ourWonderfulProducts: "de nos merveilleux produits",
    cart: "Panier",
    home: "Accueil",
    ...
    jobsComingSoon: "Emplois bientôt disponibles",
    jobsComingSoonDescription: "Nous travaillons à l'ajout de nouvelles opportunités d'emploi. Restez à l'écoute pour les mises à jour sur les postes disponibles prochainement.",
    growthOpportunities: "Opportunités de croissance",
    growthOpportunitiesDesc: "Nous offrons des opportunités de développement professionnel et de croissance de carrière",
    globalTeam: "Équipe mondiale",
    globalTeamDesc: "Travaillez avec une équipe diversifiée de plus de 10 pays",
    benefits: "Avantages",
    benefitsDesc: "Nous offrons un ensemble d'avantages compétitifs pour nos employés",
    ...
    itemOutOfStock: "Produit en rupture de stock",
  ...
  en: {
    ...
    login: "Login",
    products: "products",
    ourWonderfulProducts: "of our wonderful products",
    cart: "Cart",
    home: "Home",
    ...
    jobsComingSoon: "Jobs Coming Soon",
    jobsComingSoonDescription: "We are working on adding new job opportunities. Stay tuned for updates on available positions coming soon.",
    growthOpportunities: "Growth Opportunities",
    growthOpportunitiesDesc: "We provide opportunities for professional development and career growth",
    globalTeam: "Global Team",
    globalTeamDesc: "Work with a diverse team from more than 10 countries",
    benefits: "Benefits",
    benefitsDesc: "We offer a competitive benefits package for our employees",
