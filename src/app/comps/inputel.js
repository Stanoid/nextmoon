...
function InputEl(props) {
  return (
    ...
    ? <div class="w-full">
      ...
      <div class="relative">
        <select value={props.value} onChange={(e)=>{props.outputfunc(e.target.value)}} class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
        <option value={null}   selected>Choose a  {props.label} </option>
