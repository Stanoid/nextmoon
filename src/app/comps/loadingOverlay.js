...
function LoadingOverlay() {
  return (
    <div className=" bg-[url('../../public/amblemblack.svg')] bg-white" style={{backgroundSize:20,position:"fixed",zIndex:10,width:"100svw",height:"100vh",top:0,left:0,alignItems:"center",justifyContent:"center",display:"flex"}}>
