...
// `
    ...
    <img className='rounded-md w-3/4 sm:w-3/4 lg:w-full ' src='https://miniback-ec254e66064d.herokuapp.com/uploads/35290_10_23aee78a3f.JPG'  />
...
// `
    ...
    <div className=' flex flex-col justify-center items-center '  style={{gridArea:"namear"}}>
    <img className='rounded-md  w-3/4 sm:w-3/4 lg:w-full' src='https://miniback-ec254e66064d.herokuapp.com/uploads/35015_1_16de904fb9.JPG'  />
   <div className='text-center text-sm mt-2' >
   منتجات أمهات
    <div className='text-moon-200/80' >
المزيد
...
<div className='mx-2 min-w-10 lg:hidden'></div>
    ...
    <img className='rounded-full shadow-lg ' src='https://miniback-ec254e66064d.herokuapp.com/uploads/34993_1_fb27517586.JPG' width={"100%"} />
   ...
   جلابية مطرزة بالاحمر
    ...
    <img className='rounded-full shadow-lg' src='https://miniback-ec254e66064d.herokuapp.com/uploads/35292_1_52fd9bd58e.JPG' width={"100%"} />
   <div className='text-center text-sm font-medium mt-2' >
   جلابية مطرزة بالاحمر
    <div className='text-moon-200/80' >
    <div className="mt-1 mb-3 flex items-center  w-full justify-between">
    ...
    <img className='rounded-full shadow-lg ' src='https://miniback-ec254e66064d.herokuapp.com/uploads/35290_1_4e7d006a9c.JPG' width={"100%"} />
   <div className='text-center text-sm font-medium mt-2' >
   جلابية مطرزة بالاحمر
    <div className='text-moon-200/80' >
    <div className="mt-1 mb-3 flex items-center  w-full justify-between">
    ...
    <div className=' flex flex-col mx-2 justify-center items-center py-2  min-w-36'  style={{gridArea:"namear"}}>
    <img className='rounded-full shadow-lg ' src='https://miniback-ec254e66064d.herokuapp.com/uploads/34976_1_c114663dc9.JPG' width={"100%"} />
   <div className='text-center text-sm font-medium mt-2' >
   جلابية مطرزة بالاحمر
    <div className='text-moon-200/80' >
    <div className="mt-1 mb-3 flex items-center  w-full justify-between">
    ...
    <div className=' flex flex-col mx-2 justify-center items-center py-2  min-w-36'  style={{gridArea:"namear"}}>
    <img className='rounded-full shadow-lg' src='https://miniback-ec254e66064d.herokuapp.com/uploads/35277_12_eb8c6614d8.JPG' width={"100%"} />
   <div className='text-center text-sm font-medium mt-2' >
   جلابية مطرزة بالاحمر
    <div className='text-moon-200/80' >
    <div className="mt-1 mb-3 flex items-center  w-full justify-between">
...
// `
    ...
    <img className='rounded-md  w-3/4 sm:w-3/4 lg:w-full' src='https://miniback-ec254e66064d.herokuapp.com/uploads/35014_2_ca67a10285.JPG' />
