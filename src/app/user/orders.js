            ...
            <div className='p-5 sm:p-6 bg-gradient-to-r from-gray-50 to-white border-b-2 border-gray-100'>
              <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
                <div className='flex items-center gap-4'>
                  ...
                  <div>
                    <div className='text-lg font-bold text-gray-900'>طلب رقم {order.id || index + 1}</div>
                    <div className='text-sm text-gray-500 mt-0.5 flex items-center gap-2'>
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                      </svg>
                      {order.date || new Date().toLocaleDateString('ar-DZ')}
                    </div>
                  </div>
                </div>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6'>
                <div className='flex items-center gap-3 p-4 bg-gray-50 rounded-xl'>
                  ...
                  <div>
                    ...
                    <div className='font-bold text-gray-900 mt-0.5'>{order.payment_type || 'نقدي'}</div>
                  </div>
                </div>
                ...
                <div className='flex items-center gap-3 p-4 bg-gray-50 rounded-xl'>
                  ...
                  <div>
                    ...
                    <div className='font-bold text-gray-900 mt-0.5'>{order.delivery_type || 'توصيل منزلي'}</div>
                  </div>
                </div>
                ...
                <div className='flex items-center gap-3 p-4 bg-gray-50 rounded-xl'>
                  ...
                  <div>
                    ...
                    <div className='font-bold text-gray-900 mt-0.5'>{order.payment_status || 'مدفوع'}</div>
                  </div>
                </div>
              </div>
                    ...
                    {trackingSteps.map((step, idx) => (
                      <div key={idx} className='flex flex-col items-center flex-1'>
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg transition-all duration-300 ${
                          step.isActive ? 'shadow-lg scale-110' : 'bg-gray-200'
                        }`} style={step.isActive ? {backgroundColor: Theme.primary, color: 'white'} : {}}>
                          {step.isActive ? step.icon : idx + 1}
                        </div>
                        <div className={`text-xs mt-3 text-center font-medium px-2 ${
