...
console.log("search")
  ...
  return (
      ...
      <body className={ArFont.className} style={{}}>
        ...
        <CartContext>
          <AuthenContext>
            ...
            <div className=" p-3 w-full bg-[url('../../public/amblemblack.svg')] bg-moon-200 from-moon-200 to-moon-200 text-white shadow-lg"
    ...
    <div className="my-3 lg:my-0 md:my-0 sm:my-3   sm:w-full lg:w-2/6 p-2 py-2 ">
...
<Button  isIconOnly className="bg-white text-xl  text-moon-200  rounded-full mx-1" size="md" variant="shadow"  aria-label="Like">               
    ...
    {/* </Tooltip> */}
     ...
     <Button onClick={()=>{router.push("/login")} } variant="shadow" className="text-white text-xs rounded-lg
      bg-moonsec-100/80 font-bold shadow-md" endContent={<FaUserCircle />}> تسجيل دخول </Button>
     </motion.div>
