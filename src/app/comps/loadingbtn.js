...
<button onClick={props.act} style={{display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:Theme.primary}} className="mt-4 w-full  text-white py-2 rounded-md text-lg tracking-wide">
